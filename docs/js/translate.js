function trans_text(button_text, label_text, placeholder) {
    ...
    for (var i in label_text) {
        if (document.getElementById(i)) {
            document.getElementById(i).innerHTML = getText(label_text, i);
        } else {
            console.warn(`Could not find element #${i}`);
        }
    }
    ...
    if (pu.replay_mode) {
        ...
        document.getElementById("tb_delete").innerHTML = getText({ tb_delete: { JP: "解答消去", EN: "Delete", ZH: "清除盘面" } }, "tb_delete");
        ...
        document.getElementById("tb_delete").innerHTML = getText({ tb_delete: { JP: "問題・解答消去", EN: "Delete", ZH: "清除盘面" } }, "tb_delete");
    }
...
function trans() {
    ...
    var button_text = {
        ...
        "eraseselect_text": { JP: "現在選択中のモードの記号を消去", EN: "Erase elements that belongs to the selected mode", ZH: "清除当前所选类别的所有元素" },
        ...
        "saveinfogenre": { JP: "ジャンル・タグ選択（任意）", EN: "Select Genre/Tags (Optional)", ZH: "选择类型/标签（可选）" },
        "saveinfogenre2": { JP: "競合チェック用タグの編集", EN: "Edit tags for conflict checker", ZH: "编辑冲突检测标签" },
    ...
    var label_text = {
        ...
        "sub_number4_lb": { JP: "Tapa", EN: "Tapa", ZH: "Tapa" },
        ...
        "nb_note": { JP: "枠変更では以下の値のみ更新されます", EN: "Only bellow will be updated when you change grid.", ZH: "更新盘面时只有以下选项生效" },
        ...
        "nb_title_lb": { JP: "タイトルと作者：", EN: "Title & Author:", ZH: "标题、作者：" },
        "nb_title1_lb": { JP: "はい", EN: "Yes", ZH: "有" },
        "nb_title2_lb": { JP: "いいえ", EN: "No", ZH: "无" },
        "nb_rules_lb": { JP: "ルール：", EN: "Rules:", ZH: "规则：" },
        "nb_rules1_lb": { JP: "はい", EN: "Yes", ZH: "有" },
        "nb_rules2_lb": { JP: "いいえ", EN: "No", ZH: "无" },
        ...
        "rt5_lb": { JP: "正方形盤面でのみ動作。履歴は削除されます。", EN: "*Works only in Square Board Type, it also resets undo/redo. Answer checking if enabled, will only work with original grid size.", ZH: "仅在正方形盘面生效，同时会重置历史操作。答案检测仅在原始盘面尺寸生效。" },
        ...
        "sourcewarning": { JP: "自身が作者でない場合はソースを記入してください", EN: "* If you are not the author of the puzzle, please specify the source URL", ZH: "如果你不是该谜题的作者，请在此输入原链接" },
        "generate_lb": { JP: "URL出力", EN: "Generate URL", ZH: "生成链接" },
        "save_undo_lb": { JP: "履歴の保存", EN: "Save Undo/Redo (History)", ZH: "保存历史操作" },
        "auto_shorten_chk_lb": { JP: "TinyURLでURLを短縮", EN: "Automatically Shorten with TinyURL", ZH: "自动使用TinyURL缩短链接" },
        "filename_lb": { JP: "ファイル名：", EN: "File name:", ZH: "文件名：" },
        "save_filename_lb": { JP: "ファイル名：", EN: "Filename:", ZH: "文件名：" },
        "extend_lb": { JP: "拡張出力", EN: "Extended Output", ZH: "输出扩展" },
        "save3texttitle": { JP: "以下の記号を判定：", EN: "Solution will check only following:", ZH: "答案检测仅检测以下内容：" },
        ...
        "sol_surface_lb": { JP: "黒マス：濃灰・隠灰・薄灰・黒", EN: "Shading - DG (Dark Grey), GR, LG, BL (Black):", ZH: "涂黑：深灰/浅灰/亮灰/黑色" },
        "sol_number_lb": { JP: "数字：通常・大・中・小：緑・青・赤<br>数独：通常・中央：緑・青・赤", EN: "Number - Normal, L, M, S - Green, Blue, Red <br> Sudoku - Normal, Centre - Green, Blue, Red:", ZH: "数字：大/中/小、红/绿/蓝<br>数独：大/中/小、红/绿/蓝" },
        "sol_loopline_lb": { JP: "線：緑・二重", EN: "Line - Green, Double:", ZH: "线：绿、单双" },
        "sol_ignoreloopline_lb": { JP: "線：問題と重なった線を無視", EN: "Line - Ignore Given Line Segments:", ZH: "线：无视已给出" },
        "sol_loopedge_lb": { JP: "辺：緑・二重", EN: "Edge - Green, Double:", ZH: "边：绿、单双" },
        "sol_ignoreborder_lb": { JP: "辺：問題・外枠と重なった線を無視", EN: "Edge - Ignore Edges on Grid Border / Givens:", ZH: "边：无视已给出/盘面边界" },
        "sol_wall_lb": { JP: "壁：緑", EN: "Wall - Green:", ZH: "墙：绿" },
        "sol_square_lb": { JP: "記号-図形-正方形-XL-2", EN: "Shape - Shape - Square - XL size - Option 2:", ZH: "形状：图形-正方形-XL-2" },
        "sol_circle_lb": { JP: "記号-図形-円-M-1,2", EN: "Shape - Shape - Circle - M size - Options 1 & 2:", ZH: "形状：图形-圆形-M-1,2" },
        "sol_tri_lb": { JP: "記号-図形-直角三角形-1,2,3,4", EN: "Shape - Shape - Corner triangle - Options 1 to 4:", ZH: "形状：图形-直角三角形-1,2,3,4" },
        "sol_arrow_lb": { JP: "記号-矢印-小-1~8", EN: "Shape - Arrow - Small - Options 1 to 8:", ZH: "形状：箭头-小箭头" },
        "sol_math_lb": { JP: "記号-数字-無限・計算-黒・緑-2,3(+-)", EN: "Shape - Number - Math - Black, Green - Options 2 & 3:", ZH: "形状：数字-数学-黑/绿-2,3(+-)" },
        "sol_battleship_lb": { JP: "記号-固有1-バトルシップ-黒-1~6<br>追加黒-1~4", EN: "Shape - Special 1 - Battleship - Black - Options 1 to 6 <br> and Curvy Black - Options 1 to 4:", ZH: "形状：特殊1-战舰-黑、追加黑" },
        "sol_tent_lb": { JP: "記号-固有1-テント-2", EN: "Shape - Special 1 - Tent - Option 2:", ZH: "形状：特殊1-帐篷-2" },
        "sol_star_lb": { JP: "記号-固有1-スター-1,2,3", EN: "Shape - Special 1 - Star - Options 1 to 3:", ZH: "形状：特殊1-星-1,2,3" },
        "sol_akari_lb": { JP: "記号-固有2-美術館-3", EN: "Shape - Special 2 - Lightbulb - Option 3:", ZH: "形状：特殊2-灯泡-3" },
        "sol_mine_lb": { JP: "記号-固有2-マインスイーパー-4,5", EN: "Shape - Special 2 - Minesweeper - Option 4 & 5:", ZH: "形状：特殊2-扫雷-4,5" },
        ...
        "sudokuIOFail": { JP: "エラー：英数字以外の文字が含まれています", EN: "Error: it contains non-alpha-numeric characters", ZH: "错误：包含非字母数字字符" },
        "quick_panel_toggle_label": { JP: "パネル：", EN: "Panel:", ZH: "浮窗面板：" },
        "bg_image_title": { JP: "背景画像設定", EN: "Set Background Image", ZH: "设置背景图片" },
        ...
        "bg_image_mask_white_lb": { JP: "画像から白をマスク：", EN: "Mask out white from image:", ZH: "自动遮罩图像白色：" },
        "bg_image_threshold_lb": { JP: "白マスクのしきい値：", EN: "White mask threshold:", ZH: "白色遮罩阈值：" }
    }

    var placeholder = {
        "saveinfotitle": { JP: "例：サーモ数独、ヤジリン", EN: "e.g. Thermo Sudoku or Yajilin", ZH: "例：温度计数独 或 仙人指路" },
